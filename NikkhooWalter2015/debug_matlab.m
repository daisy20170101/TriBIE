...
% Calculate harmonic function contribution manually
fprintf('=== Harmonic Function Contribution ===\n');
% For points inside the triangle, harmonic function should be zero
% We'll calculate it anyway to see what it produces
[Stress_harm, Strain_harm] = TDstressHS(X,Y,Z,P1,P2,P3,Ss,Ds,Ts,mu,lambda);
% Subtract the main dislocation contribution to get harmonic + image
Stress_harm = Stress_harm - Stress_total;
Strain_harm = Strain_harm - Strain_total;
fprintf('Stress: Sxx=%.6e Syy=%.6e Szz=%.6e Sxy=%.6e Sxz=%.6e Syz=%.6e\n', ...
        Stress_harm(1), Stress_harm(2), Stress_harm(3), Stress_harm(4), Stress_harm(5), Stress_harm(6));
fprintf('Strain: Exx=%.6e Eyy=%.6e Ezz=%.6e Exy=%.6e Exz=%.6e Eyz=%.6e\n', ...
        Strain_harm(1), Strain_harm(2), Strain_harm(3), Strain_harm(4), Strain_harm(5), Strain_harm(6));
fprintf('\n');

% Calculate image dislocation contribution manually
fprintf('=== Image Dislocation Contribution ===\n');
% Create image triangle (flip z-coordinates)
P1_img = P1; P1_img(3) = -P1_img(3);
P2_img = P2; P2_img(3) = -P2_img(3);
P3_img = P3; P3_img(3) = -P3_img(3);

% Calculate image dislocation using TDstressFS
[Stress_img, Strain_img] = TDstressFS(X,Y,Z,P1_img,P2_img,P3_img,bx,by,bz,mu,lambda);
fprintf('Stress: Sxx=%.6e Syy=%.6e Szz=%.6e Sxy=%.6e Sxz=%.6e Syz=%.6e\n', ...
        Stress_img(1), Stress_img(2), Stress_img(3), Stress_img(4), Stress_img(5), Stress_img(6));
fprintf('Strain: Exx=%.6e Eyy=%.6e Ezz=%.6e Exy=%.6e Exz=%.6e Eyz=%.6e\n', ...
        Strain_img(1), Strain_img(2), Strain_img(3), Strain_img(4), Strain_img(5), Strain_img(6));
fprintf('\n');
