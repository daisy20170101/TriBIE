...
!  integer :: nwarn
  ...
  subroutine calculate_displacements_vc(y1, y2, y3, yb3, r, rb, z1, z3, zb1, zb3, &
    ...
    vc(1,2) = -((a*ctb*y1*(-a + yb3))/rb**3) - &
      ...
      vc(1,3) =  (y2*(-a + yb3)*(a/rb**2 + (2*nu)/(rb + yb3)))/rb + &
 ...
 vc(2,2) =   -((a*ctb*y2*(-a + yb3))/rb**3) + & 
      ...
      vc(2,3) =  (-2*(1 - nu)*(2*nu + a/rb)*y1)/(rb + yb3) + &
      ...
      vc(3,1) = -((y2*(-a + yb3)*(a/rb**2 + 1/(rb + yb3)))/rb) + & 
      ...
      vc(3,2) =  (y1*(-a + yb3)*(a/rb**2 + 1/(rb + yb3)))/rb - &
      ...
      vc(3,3) = (sb*y2*(-a + yb3)*(1 + (a*yb3)/rb**2 + &
            ((cb + a/rb)*(cb*rb + yb3))/(rb + zb3)))/(rb*(rb + zb3)) + &
  ...
  subroutine calculate_derivatives_dv(y1, y2, y3, yb3, r, rb, z1, z3, zb1, zb3, &
    ...
    dv = 0.0d0
      ...
      dv(1,1,3) = -(y1*y2*(-(y3/(r**3*(r - y3))) - (-1 + y3/r)/(r*(r - y3)**2) - &
